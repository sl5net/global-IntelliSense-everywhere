...
; Msgbox,%inc17032207130% `n (from: %A_ScriptName%~%A_LineNumber%) 17-11-13_16-29
...
;MsgBox,17-11-13_16 `n A_ScriptDir=%A_ScriptDir% `n HardDriveLetter=%HardDriveLetter% `n
...
IfWinExist,hideAllAhkTray.ahk
{
  ...
  ;MsgBox,17-11-13_16-50 `n A_ScriptDir=%A_ScriptDir% `n HardDriveLetter=%HardDriveLetter% `n
...
; MsgBox,17-11-13_16-55 `n A_ScriptDir=%A_ScriptDir% `n HardDriveLetter=%HardDriveLetter% `n

Return
;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

;MsgBox,17-11-13_16-56 `n A_ScriptDir=%A_ScriptDir% `n HardDriveLetter=%HardDriveLetter% `n
...
;MsgBox,17-11-13_16-52 `n A_ScriptDir=%A_ScriptDir% `n HardDriveLetter=%HardDriveLetter% `n
