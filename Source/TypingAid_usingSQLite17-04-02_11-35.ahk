...
maxLinesOfCode4length2 := maxLinesOfCode4length1 * 9
...
if(!WinExist("Open library? (id=1703171452)") && !WinExist("TypingAid Help") && !WinExist("TypingAid Settings") && A_TimeIdle > 500 ){
   global g_ListBox_Id
...
setLength(ParseWordsCount, maxLinesOfCode4length1){
    ...
    global prefs_Length
          ...
          } else if(ParseWordsCount <= maxLinesOfCode4length2){
            prefs_Length = 2 ; 27.03.2017 10:25 17-03-27_10-25 sl5.net
          } else
            prefs_Length = 3 ; 27.03.2017 10:25 17-03-27_10-25 sl5.net
      }
