...
global g_doSaveLogFiles
 if(g_doSaveLogFiles)
lll(A_LineNumber, A_ScriptName, "Debuggging!  NOT Run % typingAidAHK " )
...
f12::
   ...
   ; run,E:\fre\private\HtmlDevelop\AutoHotKey\tools\TypingAid-master\Source, E:\fre\private\HtmlDevelop\AutoHotKey\tools\TypingAid-master
   ...
   ; vielleich is es ja auch einfach nur bl�d wenn die so schnell hintereinander augerufen werden ?????????????????? 16.11.2017 09:59
   Sleep,2000
