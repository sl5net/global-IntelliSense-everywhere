...
g_actionListDBfileAdress := "G:\fre\git\github\2\Source" "\actionListLearned.db" 
g_actionListDBfileAdress := (InStr(A_ComputerName,"540P-SL5NET")) 	? "G:\fre\private\sql\sqlite\actionList.db"  	: "G:\fre\git\github\2\Source" "\actionListLearned.db"  
...
g_config.ScriptDir := "G:\fre\git\github\2\Source" 
...
g_config.editor := [  	A_ProgramFiles "\Microsoft VS Code\Code.exe", 	 "C:\Program Files\Microsoft VS Code\Code.exe", 	 "C:\Program Files\Microsoft VS Code\bin\code.cmd", 	 "C:\Users\lauffer\AppData\Local\Programs\Microsoft VS Code\Code.exe", 	 "G:\fre\git\github\2\Source" "\..\AHK-Studio\AHK-Studio.ahk", 	 "C:\Program Files\Notepad++\notepad++.exe", 	 "G:\fre\git\github\2\Source" "\..\AutoGUI\AutoGUI.ahk" ]  ; above the list of the editors, which is gone through alphabetically up to the first find (fileAdress exists). 
...
g_config.tray := {   	iconFileAddress: ( 		( InStr("G:\fre\git\github\2\Source","-Nightly-")  		&& FileExist("G:\fre\git\github\2\Source" "\icon\abc123\GI-nightly.gif") )  			? "G:\fre\git\github\2\Source" "\icon\abc123\GI-nightly.gif"  			: ""  	)  }  
actionList_isNotAProject_withoutExt  := removesSymbolicLinksFromFileAdress( "G:\fre\git\github\2\Source" "\..\actionLists\_globalActionListsGenerated\isNotAProject" ) 
...
g_config.sql := { 	select: {  		ignReg: "m)^((?!\bActionListID\b\s*[><=]).)*$" , 		ignIfWhereIsWithoutListID : false, 		showFilePrefix : false  	}, 	template : { 		dir: "G:\fre\git\github\2\Source" "\sql\template", 		maxNnumberUsedTemplates : 7 	}, 	DB_Browser: A_ProgramFiles " (x86)\DB Browser for SQLite\DB Browser for SQLite.exe" }  
...
g_config.codeRunner := { 	code_AutoHotkey_Community:  	"G:\fre\git\github\2\Source" "\..\actionLists\_globalActionLists\incDynAhk\AutoHotkey_Community\in_commandLine_send_modified_clipboard.ahk", 	helloCommandLine: "G:\fre\git\github\2\Source" "\plugins\ahk\helloCommandLine.ahk", 	everything: A_ProgramFiles "\_\Everything\Everything.exe", 	everythingEs: A_ProgramFiles "\_\Everything\ES\es.exe", 	javascript: "node", 	php731NTS: "C:\php731NTS\php.exe",  	php: "C:\php\php.exe", 	python: "python", 	perl: "perl", 	ruby: "C:\Ruby23-x64\bin\ruby.exe", 	go: "go run", 	html: "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe", 	java: "cd $dir && javac $fileName && java $fileNameWithoutExt", 	c: "cd $dir && gcc $fileName -o $fileNameWithoutExt && $dir$fileNameWithoutExt", 	kotlinc: "G:\fre\git\github\2\Source" "\..\actionLists\_kts\kotlinc\bin\kotlinc" } 
