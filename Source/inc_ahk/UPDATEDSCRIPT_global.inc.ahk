...
;  fileAHKabs = %ScriptDir% ; \SaveLast5_to_BackupSL5.ahk
 ...
 ; i want copy it in the same path and into a google drive path
		...
		list := "E:\fre\private\HtmlDevelop\AutoHotKey\distributorSL5\" A_ScriptName ".txt"
		if(!FileExist(list))
			list := "distributorSL5\" A_ScriptName ".txt"
		RunWait, %scriptDir%\distributorSL5.ahk "list=%list%", %scriptDir%
		list := "E:\fre\private\HtmlDevelop\AutoHotKey\distributorSL5\" "distributorSL5.ahk" ".txt"
		RunWait, %scriptDir%\distributorSL5.ahk "list=%list%", %scriptDir%
		list := "E:\fre\private\HtmlDevelop\AutoHotKey\distributorSL5\" "UPDATEDSCRIPT_global.inc.ahk" ".txt"
		RunWait, %scriptDir%\distributorSL5.ahk "list=%list%", %scriptDir%
