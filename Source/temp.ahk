...
g_lineNumberFeedback=Typing_Aid_everywhere_multi_clone.ahk~~438 token363 
...
activeTitle = howto check Send,^v is finished? - AutoHotkey Community - Google Chrome
activeClass = ChromeWidgetWin1
ActionListNEW = howto check Send,^v is finished? - AutoHotkey Community - Google Chrome 
...
if(1 && l1 > l2){ ; proof it test it
    ...
    if(1 && InStr(A_ComputerName,"SL5"))
        msgbox,% ActionList " 12is saved (l1 > l2) (G:\fre\git\github\2\Source\Typing_Aid_everywhere_multi_clone.ahk~492) (" RegExReplace(A_LineFile,".*\\") "~" A_LineNumber ") ---- " fileContent
    tooltip,% ActionList " 12is saved (l1 > l2) (G:\fre\git\github\2\Source\Typing_Aid_everywhere_multi_clone.ahk~492) (" RegExReplace(A_LineFile,".*\\") "~" A_LineNumber ") ---- " fileContent
}
