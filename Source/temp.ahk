...
g_lineNumberFeedback=Typing_Aid_everywhere_multi_clone.ahk~~395 token363 
...
if(1 && l1 > l2){ ; proof it test it
    ...
    if(1 && InStr(A_ComputerName,"SL5"))
        msgbox,% ActionList " 12is saved (l1 > l2) (G:\fre\git\github\2\Source\Typing_Aid_everywhere_multi_clone.ahk~436) (" RegExReplace(A_LineFile,".*\\") "~" A_LineNumber ") ---- " fileContent
    tooltip,% ActionList " 12is saved (l1 > l2) (G:\fre\git\github\2\Source\Typing_Aid_everywhere_multi_clone.ahk~436) (" RegExReplace(A_LineFile,".*\\") "~" A_LineNumber ") ---- " fileContent
}
