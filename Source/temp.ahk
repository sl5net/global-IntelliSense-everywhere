...
g_lineNumberFeedback=Typing_Aid_everywhere_multi_clone.ahk~~369 token363 
...
g_lineNumberFeedback=G:\downloads\p\global-IntelliSense-everywhere-Nightly-Build-master\Source\Typing_Aid_everywhere_multi_clone.ahk~~353
...
ActionListFilterPath2Abs = G:\downloads\p\global-IntelliSense-everywhere-Nightly-Build-master\Source\..\ActionLists\_globalActionListsGenerated\ActionListNameFilter.inc.ahk 
...
#Include *i G:\downloads\p\global-IntelliSense-everywhere-Nightly-Build-master\Source\..\ActionLists\_globalActionListsGenerated\ActionListNameFilter.inc.ahk  ; thats the subfolder  wordlost inside class 
varInjects1 := mvarInjects(ActionListDir, ActionListNEW, activeClass, activeTitle) 
ActionListOLD = GitHub Desktop 
typingAidSourcePath =  
ActionListActive  =  
...
if(1 && l1 > l2){ ; proof it test it
    ...
    ;msgbox,% ActionList " 12is saved (l1 > l2) (G:\downloads\p\global-IntelliSense-everywhere-Nightly-Build-master\Source\Typing_Aid_everywhere_multi_clone.ahk~410) (" A_LineFile "~" A_LineNumber ") ---- " fileContent
    tooltip,% ActionList " 12is saved (l1 > l2) (G:\downloads\p\global-IntelliSense-everywhere-Nightly-Build-master\Source\Typing_Aid_everywhere_multi_clone.ahk~410) (" A_LineFile "~" A_LineNumber ") ---- " fileContent
}
