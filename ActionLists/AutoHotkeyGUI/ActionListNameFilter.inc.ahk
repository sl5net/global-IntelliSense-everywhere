...
if (!ActionListNEW ){
 ...
 g_lineNumberFeedback=G:\fre\git\github\2\Source\inc_ahk\Typing_Aid_everywhere_multi_clone.inc.ahk~getAhkCodeInsideFile~995
...
; Clipboard := ActionListNEW `n G:\fre\git\github\2\Source\inc_ahk\Typing_Aid_everywhere_multi_clone.inc.ahk~getAhkCodeInsideFile~995 `n we dont need that anymore. becouse now we work without the clipboard 09.03.2017 21:21 isInternMsgTransportIsClipboard := false ; false. then using fileSystem: readfile, include copyfile
